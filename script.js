...
// Actualizado con precisión absoluta: Calle Junín y Velasco Galvarro
...
function iniciarCamion30Segundos() {
    navigator.geolocation.getCurrentPosition(
        function(pos) {
            ...
            marcadorUsuarioConectado = L.marker([lat, lng])
                .addTo(map)
                .bindPopup(`<b>🚛 Camión Recolector</b>`);
...
function actualizarPopup(punto) {
    ...
    if (modo === 'camion' || modo === 'admin') {
        botonesLogistica = `
            <button onclick="trazarRutaHaciaPunto(${punto.lat},${punto.lng})" style="width:100%; margin-bottom:6px; padding:6px; border:none; border-radius:4px; background:#00f0ff; color:black; font-weight:bold; cursor:pointer;">Resumen 3🚛 Trazar Ruta</button>
